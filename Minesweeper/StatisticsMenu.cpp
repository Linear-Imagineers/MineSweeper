...
StatisticsMenu::StatisticsMenu(wxWindow* parent) : wxPanel(parent) {
    ...
    ExitButton->Bind(wxEVT_BUTTON, &StatisticsMenu::OnExit, this);
...
void StatisticsMenu::OnExit(wxCommandEvent& event) {
